  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-opacity-50 z-[99]">
      <div className="bg-background p-6 w-screen h-screen overflow-y-auto relative">
        ...
        <button onClick={onClose} className="fixed bg-background top-10 right-10 text-background rounded hover:scale-110 transition-transform ease-in-out duration-200 w-fit ">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="#d58a75" className="w-10 h-10">
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
          </svg>
        </button>
        
        <h2 className="text-xl font-bold mb-4 text-center m-10 text-hommes font-agrandir">Noms de rues maculines</h2>
...
export default function PourcentHommes({ genreDataM, masculineStreetNames }) {
  ...
  return (
    <section id="pourcentHommes">
          ...
          <animated.div style={bgProps} className='h-screen relative flex justify-center items-center'>
            <div className="w-1/2 mx-auto flex flex-col justify-end items-center h-3/4">
              <div className="text-center">
                ...
                <button onClick={openModal} className="font-[agrandir] text-sm mb-8 bg-background text-hommes py-2 px-2 rounded hover:scale-110 transition-transform ease-in-out duration-200 uppercase w-fit">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} streetNames={masculineStreetNames} />
